...
// let student = new Employee('Hamza', 'Tuesday')
// student.getSchedule(student.name, student.shifts)
...
// const newEmployees = new Manager('Hamza', 'Mark')
// newEmployees.getEmployees(newEmployees.name, newEmployees.shifts);
// console.log(addEmployees(employees));
